...
public class LAServlet2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cc.setLat(null);
		stud.setLa(cc);
		Configuration con = new Configuration().addAnnotatedClass(LAStudents.class).addAnnotatedClass(LAClasses.class).addAnnotatedClass(LATeachers.class).addAnnotatedClass(LASubjects.class);
